import{r as s,j as e}from"./index-COfN0LqL.js";const l={"property-ownership":{title:"Property Ownership Rights in Nigeria",category:"Property Law",icon:"🏠",content:`
...
4. All deeds are registered before final disbursement to seller
    `},"stamp-duty":{title:"Stamp Duty & Property Tax",category:"Tax & Fiscal",icon:"📋",content:`
...
- Tax receipt generated for all parties
    `},"tenancy-law":{title:"Tenancy & Landlord-Tenant Law",category:"Tenancy Law",icon:"🤝",content:`
...
- Legal consultation referral service
    `},"anti-fraud":{title:"Anti-Fraud & Money Laundering",category:"Compliance",icon:"🛡️",content:`
...
- Biometric verification eliminates anonymous actors
    `},"dispute-resolution":{title:"Dispute Resolution Framework",category:"Dispute Resolution",icon:"⚖️",content:`
...
- **CBN Payment System Guidelines** (payment protection)
    `}},g=["All","Property Law","Tax & Fiscal","Tenancy Law","Compliance","Dispute Resolution"];function h(){const[a,c]=s.useState(null),[o,d]=s.useState("All"),[n,p]=s.useState(""),m=Object.entries(l).filter(([,t])=>{const r=o==="All"||t.category===o,u=!n||t.title.toLowerCase().includes(n.toLowerCase())||t.content.toLowerCase().includes(n.toLowerCase());return r&&u}),i=a?l[a]:null;return e.jsxs("div",{style:{minHeight:"100vh",background:"#f8fafc",fontFamily:"Inter,sans-serif"},children:[e.jsxs("nav",{style:{background:"#1e3a5f",padding:"1rem 1.5rem",display:"flex",justifyContent:"space-between",alignItems:"center"},children:[e.jsxs("a",{href:"/",style:{color:"#fff",fontWeight:800,textDecoration:"none"},children:["🏠 VeriProp ",e.jsx("span",{style:{color:"#f59e0b"},children:"Nigeria"})]}),e.jsx("span",{style:{color:"#94a3b8",fontSize:"0.875rem"},children:"⚖️ Legal Database"})]}),e.jsxs("div",{style:{maxWidth:1100,margin:"0 auto",padding:"1.5rem 1rem"},children:[e.jsxs("div",{style:{textAlign:"center",marginBottom:"2rem"},children:[e.jsx("h1",{style:{color:"#1e3a5f",fontWeight:900,margin:"0 0 0.5rem"},children:"📚 Nigeria Property Law Database"}),e.jsx("p",{style:{color:"#64748b",fontSize:"0.9rem"},children:"Comprehensive legal reference for Nigerian property transactions"})]}),e.jsxs("div",{style:{display:"flex",gap:"0.75rem",marginBottom:"1.5rem",flexWrap:"wrap"},children:[e.jsx("input",{value:n,onChange:t=>p(t.target.value),placeholder:"Search legal topics...",style:{flex:1,minWidth:200,padding:"0.625rem 0.875rem",border:"1px solid #e2e8f0",borderRadius:"0.5rem",fontSize:"0.875rem",outline:"none"}}),g.map(t=>e.jsx("button",{onClick:()=>d(t),style:{padding:"0.5rem 0.875rem",border:"none",background:o===t?"#1e3a5f":"#fff",color:o===t?"#fff":"#64748b",borderRadius:"0.5rem",cursor:"pointer",fontWeight:600,fontSize:"0.8rem",boxShadow:"0 1px 4px rgba(0,0,0,0.06)"},children:t},t))]}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:i?"320px 1fr":"1fr",gap:"1.25rem"},children:[e.jsx("div",{children:m.map(([t,r])=>e.jsx("div",{onClick:()=>c(a===t?null:t),style:{background:"#fff",borderRadius:"0.875rem",padding:"1.125rem",marginBottom:"0.75rem",cursor:"pointer",border:`2px solid ${a===t?"#1e3a5f":"#e2e8f0"}`,boxShadow:"0 2px 8px rgba(0,0,0,0.05)",transition:"all 0.2s"},children:e.jsxs("div",{style:{display:"flex",gap:"0.875rem",alignItems:"center"},children:[e.jsx("span",{style:{fontSize:"1.75rem"},children:r.icon}),e.jsxs("div",{children:[e.jsx("div",{style:{fontWeight:700,color:"#1e3a5f",fontSize:"0.9rem"},children:r.title}),e.jsx("div",{style:{color:"#64748b",fontSize:"0.75rem",marginTop:"0.15rem"},children:r.category})]}),e.jsx("span",{style:{marginLeft:"auto",color:"#94a3b8"},children:a===t?"▲":"▼"})]})},t))}),i&&e.jsxs("div",{style:{background:"#fff",borderRadius:"1rem",padding:"2rem",boxShadow:"0 2px 12px rgba(0,0,0,0.06)",border:"1px solid #e2e8f0",overflowY:"auto",maxHeight:"80vh"},children:[e.jsxs("div",{style:{display:"flex",gap:"0.75rem",alignItems:"center",marginBottom:"1.5rem"},children:[e.jsx("span",{style:{fontSize:"2.5rem"},children:i.icon}),e.jsxs("div",{children:[e.jsx("h2",{style:{color:"#1e3a5f",fontWeight:900,margin:0,fontSize:"1.1rem"},children:i.title}),e.jsx("span",{style:{background:"#eff6ff",color:"#1d4ed8",padding:"0.15rem 0.6rem",borderRadius:"999px",fontSize:"0.7rem",fontWeight:700},children:i.category})]})]}),e.jsx("div",{style:{color:"#374151",lineHeight:1.8,fontSize:"0.875rem",whiteSpace:"pre-wrap"},children:i.content.trim().split(`
`).map((t,r)=>t.startsWith("## ")?e.jsx("h3",{style:{color:"#1e3a5f",fontWeight:800,marginTop:"1.5rem",marginBottom:"0.5rem"},children:t.slice(3)},r):t.startsWith("### ")?e.jsx("h4",{style:{color:"#1d4ed8",fontWeight:700,marginTop:"1rem",marginBottom:"0.35rem"},children:t.slice(4)},r):t.startsWith("**")&&t.endsWith("**")?e.jsx("p",{style:{fontWeight:700,color:"#1e3a5f",margin:"0.5rem 0"},children:t.slice(2,-2)},r):t.startsWith("- ")?e.jsx("li",{style:{marginLeft:"1.25rem",marginBottom:"0.25rem"},children:t.slice(2)},r):t.startsWith("1. ")||t.startsWith("2. ")||t.startsWith("3. ")?e.jsx("li",{style:{marginLeft:"1.25rem",marginBottom:"0.25rem"},children:t.replace(/^\d+\. /,"")},r):t.trim()?e.jsx("p",{style:{margin:"0.35rem 0"},children:t},r):e.jsx("br",{},r))}),e.jsx("div",{style:{marginTop:"1.5rem",padding:"1rem",background:"#eff6ff",borderRadius:"0.625rem"},children:e.jsxs("p",{style:{color:"#1d4ed8",fontSize:"0.8rem",margin:0,textAlign:"center"},children:["⚠️ This is general legal information only. For specific legal advice, consult a qualified Nigerian property lawyer. VeriProp offers legal referral services — ",e.jsx("a",{href:"/ai/advisor",style:{color:"#1d4ed8",fontWeight:700},children:"consult VetPro AI →"})]})})]})]})]})]})}export{h as default};
